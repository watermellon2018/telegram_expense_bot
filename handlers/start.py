...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        message = (
            ...
            "• /recommendations - персональные рекомендации по расходам\n"
            "• /rec_like <recommendation_id> - отметить рекомендацию полезной\n"
            "• /rec_dislike <recommendation_id> - отметить рекомендацию неполезной\n"
            "• /rec_dismiss <recommendation_id> - скрыть рекомендацию\n"
